# Parcear el archivo json para abstraer en clases la informacion contenida en el archivo
# coding=utf-8
#Lo que está en Data, se tiene que hacer clase y asi to-do al menos dos propiedades
import json

json_file = open('marvel.json'.read())
json_data = json.loads(jason_file)
